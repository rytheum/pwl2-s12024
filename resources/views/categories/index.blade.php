...
<head>
    ...
    position: fixed;
    bottom: 0;
    left: 250px; /* default sama sidebar */
    right: 0;
    height: 50px;
    display: flex;
    align-items: center;
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <a href="{{ route('categories.index') }}" class="active"><i class="fas fa-tags"></i> Categories</a>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('categories.show', $category->id) }}"
                                        class="btn btn-lg btn-primary"><i class="fas fa-eye"></i></a>
                                    <a href="{{ route('categories.edit', $category->id) }}"
                                        class="btn btn-lg btn-warning"><i class="fas fa-edit"></i></a>

                                    <form action="{{ route('categories.destroy', $category->id) }}" method="POST"
                                        class="d-inline" id="form-delete" data-title="{{ $category->id }}">
                                        @csrf
                                        @method('DELETE')
